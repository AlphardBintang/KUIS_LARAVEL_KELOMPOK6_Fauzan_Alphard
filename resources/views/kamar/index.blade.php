...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('kamars.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
            + Tambah Kamar
        </a>
    </div>

    <div class="bg-white p-4 rounded-lg shadow mb-6">
        <form action="{{ route('kamars.index') }}" method="GET" class="flex flex-wrap gap-4">
            ...
            <a href="{{ route('kamars.index') }}" class="text-gray-600 px-4 py-2">Reset</a>
        </form>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="{{ route('kamars.edit', $kamar->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                        <form action="{{ route('kamars.destroy', $kamar->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin hapus kamar ini?');">
                            @csrf
                            @method('DELETE')
