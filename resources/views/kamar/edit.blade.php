...
<div class="max-w-2xl mx-auto px-4 sm:px-0">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Edit Kamar</h1>

    <form action="{{ route('kamar.update', $kamar->id) }}" method="POST" class="bg-white shadow-md rounded-lg p-4 sm:p-6 space-y-4">
        @csrf
        @method('PUT')
